...
import * as THREE from './vendor/three.module.min.js?v=eb8d99fd';
import * as dem from './dem.js?v=eb8d99fd';
import * as sat from './sat.js?v=eb8d99fd';
import { mercX, mercY } from './geo.js?v=eb8d99fd';
import { pointAt } from './track.js?v=eb8d99fd';
import { GLTFLoader } from './vendor/GLTFLoader.js?v=eb8d99fd';
import * as icons from './icons3d.js?v=eb8d99fd';
import { poisNear } from './data-mod.js?v=eb8d99fd';
import { stageFlags } from './render.js?v=eb8d99fd';
...
export function loadAvatar(url) {
  if (!ok || avatar) return;
  import('./rider3d.js?v=eb8d99fd').then(m => m.createAvatar(url)).then(a => {
