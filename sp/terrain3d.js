...
import { pointAt } from './track.js?v=a4f89d61';
import { GLTFLoader } from './vendor/GLTFLoader.js?v=a4f89d61';
import * as icons from './icons3d.js?v=a4f89d61';
import { poisNear } from './data-mod.js?v=a4f89d61';
import { stageFlags } from './render.js?v=a4f89d61';
...
export function loadAvatar(url) {
  if (!ok || avatar) return;
  import('./rider3d.js?v=a4f89d61').then(m => m.createAvatar(url)).then(a => {
