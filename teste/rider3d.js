...
export function render(r, v, t) {
  ...
  const size = Math.round(84 * (r.scale || 1)); const x0 = Math.round(r.x - size / 2), y0 = Math.round(H - r.y - size * 0.36);   // mesmo tamanho do ícone 2D da bike (84 px), pedido do Pedro em 06/09
